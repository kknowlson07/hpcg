...
for LOG_FILE in "${{LOG_FILES[@]}}"; do
        ...
        echo "NTasks:{ntasks},Mem:{mem},Nodes:{nodes},GPU:{gpu},Threads:{threads},Nx:{ny},Ny:{ny},Nz:{nz},rt:{rt},GFLOPS:$GFLOP,EXEC:$EXEC_TIME,optP:$OPT_PHASE_TIME,SPMV:$SPMV_TIME,MG:$MG_TIME" >> "$RESULTS_CSV"
